...
function Donations() {
  ...
  const [filterAmount, setFilterAmount] = useState(''); // New: Filter by amount
  ...
  const categories = [
    ...
    'Disaster Relief',
    'Environment',
    ...new Set(campaigns.map((camp) => camp.category || 'Uncategorized')),
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {filteredCampaigns.length === 0 ? (
            ...
            filteredCampaigns.map((camp) => (
              ...
              >
                <img
                  src={camp.imageUrl || 'https://via.placeholder.com/500x200'}
                  alt={camp.name}
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    <p className="text-sm text-gray-500">
                      Raised: ${camp.amountRaised || 0} / ${camp.fundingGoal} | Needed: $
                      {(camp.fundingGoal - (camp.amountRaised || 0)).toFixed(2)}
                    </p>
                    <button
